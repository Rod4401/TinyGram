        ...
        this.body = "";
            ...
            [
              m("div", {"class":"centered-width"}, 
                m("p", {"class":"text-justify fw-bold","style":{"font-family":"Dancing Script","font-size":"25px"}}, 
                    ...
                    m("div", {"class":"row row-cols-1"},
                      [
                        ...
                        m("div", {"class":"col mt-1","id":"description"}, 
                          m("textarea", {"oninput": function(){NewPost.body = this.value},"class":"form-control textArea","id":"textAreaDescription","rows":"8","placeholder":"Ajoutez une légende..."})
                        ),
